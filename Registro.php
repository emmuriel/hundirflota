...
<body class="bg-dark" >
    ...
    <div class="container min-vw-25">
        <div class="row">
            <div class="col">
                <div class="mb-3">
                    <h1 class="cabecera text-light text-center">Hundir<span>Flota</span></h1>
                </div>
                <form id="form1" method="POST" action="Registro.php" class="shadow-lg p-5 pt-0 pb-1 m-4 mt-1 mb-0">
                    ...
                    <div>
                        ...
                        <input type="password" class="form-control bg-dark text-light border-primary" name="password" id="txt_password">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control bg-dark text-light border-primary" name="confirmacion" id="txt_conf_pass">
                    </div>
